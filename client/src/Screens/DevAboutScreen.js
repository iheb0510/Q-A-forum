  ...
  return (
    <div className='w-full bg-white dark:bg-gray-800'>
      {profile?.topSkills?.length > 0 ? (
        <div className='mb-3'>
          <p className='font-semibold text-xl text-gray-600 dark:text-gray-200 p-1 mb-2 border-b dark:border-gray-600'>
      ...
      {profile?.education?.length > 0 ? (
        <div className='mb-3'>
          <p className='font-semibold text-xl p-1 mb-2 border-b dark:border-gray-600 text-gray-600 dark:text-gray-200'>
            <i className='fas mr-2 fa-graduation-cap'></i>Education
          </p>
