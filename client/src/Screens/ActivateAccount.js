...
const ActivateAccount = ({ history }) => {
  ...
  return (
    <div className='flex items-center justify-center min-h-screen p-5  min-w-screen'>
      <div className='max-w-xl p-8 text-center text-gray-800 dark:text-gray-100 bg-white dark:bg-gray-600 shadow-xl lg:max-w-3xl rounded-3xl lg:p-12'>
        <i
          class='fas fa-check-circle fa-7x  '
          style={{ color: '#009217', size: 30 }}
        ></i>
        <h3 className='text-4xl ml-5 lg:p-5'>Congaragulations!</h3>
        <h3 className='text-2xl'>You are now a part of Capgemini Forum !</h3>
